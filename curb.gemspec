Gem::Specification.new do |s|
  ...
  s.test_files = ["tests/mem_check.rb", "tests/bug_require_last_or_segfault.rb", "tests/helper.rb", "tests/tc_curl_postfield.rb", "tests/bug_instance_post_differs_from_class_post.rb", "tests/bug_multi_segfault.rb", "tests/alltests.rb", "tests/bug_postfields_crash.rb", "tests/require_last_or_segfault_script.rb", "tests/unittests.rb", "tests/tc_curl_multi.rb", "tests/bug_curb_easy_post_with_string_no_content_length_header.rb", "tests/tc_curl_download.rb", "tests/tc_curl_easy.rb", "tests/bug_curb_easy_blocks_ruby_threads.rb"]
