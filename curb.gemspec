Gem::Specification.new do |s|
  ...
  s.test_files = ["tests/alltests.rb", "tests/bug_curb_easy_blocks_ruby_threads.rb", "tests/bug_instance_post_differs_from_class_post.rb", "tests/bug_multi_segfault.rb", "tests/bug_require_last_or_segfault.rb", "tests/helper.rb", "tests/require_last_or_segfault_script.rb", "tests/tc_curl_download.rb", "tests/tc_curl_easy.rb", "tests/tc_curl_multi.rb", "tests/tc_curl_postfield.rb", "tests/unittests.rb"]
